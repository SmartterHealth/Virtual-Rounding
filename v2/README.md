...
* [Azure AD PowerShell Module v2](https://docs.microsoft.com/powershell/azure/active-directory/install-adv2)
* [Skype for Business Online PowerShell](https://docs.microsoft.com/office365/enterprise/powershell/manage-skype-for-businessonline-with-office-365-powershell)

### Room Setup Script

All variables and supporting files will need to be specified in the RunningConfig.json file you can find in this repository. The only variable the script needs configured manually is the location of that JSON configuration file.
...
If you chose to use Teams and Channels to for providers to join/configure meetings/rooms (in addition to, or instead of the Power App interface introduced in v2), use this section. Otherwise, proceed to the next section.
...
5. Creates Channels and pins the SharePoint list view as a Tab
6. Removes Wiki Tabs
...
* [Azure AD PowerShell Module v2](https://docs.microsoft.com/powershell/azure/active-directory/install-adv2?view=azureadps-2.0)
